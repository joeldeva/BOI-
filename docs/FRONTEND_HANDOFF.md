...
5. The result view presents malware assessment first, then deterministic score, engine execution, normalized evidence, Fraud Delta, MITRE mappings, indicators, extraction coverage and narrative.
...
The OpenAPI contract test verifies all consumed routes and confirms the removed v2 non-APK routes are absent.
