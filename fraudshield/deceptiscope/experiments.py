...
FRIDA_CAPABILITY = "frida_instrumentation_ready"
FRIDA_DEPENDENT_EXPERIMENTS = frozenset(
    {
...
def experiment_catalog() -> dict[ExperimentType, ExperimentDefinition]:
    ...
    instrumented_caps = [*dynamic_caps, FRIDA_CAPABILITY]
    return {
        ExperimentType.LAUNCH_APP: ExperimentDefinition(
            ...
            required_capabilities=instrumented_caps,
            timeout_seconds=45,
...
class TrustedExperimentRegistry:
    ...
    def environment_capabilities(self, settings: Settings) -> dict[str, bool]:
        ...
        return {
            ...
            FRIDA_CAPABILITY: (
                settings.frida_runtime_enabled and importlib.util.find_spec("frida") is not None
            ),
        }
