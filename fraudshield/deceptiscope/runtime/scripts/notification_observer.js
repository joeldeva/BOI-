...
(function() {
    ...
    Java.perform(function() {
        try {
            ...
            var originalOnNotif = NotificationListenerService.onNotificationPosted.overload("android.service.notification.StatusBarNotification");

            originalOnNotif.implementation = function(sbn) {
                try {
                    ...
                    send({
                        ...
                        metadata: {
                            source_package: pkg ? pkg.toString() : "",
                ...
                return originalOnNotif.call(this, sbn);
            };
        } catch(err) {}
    });
})();
